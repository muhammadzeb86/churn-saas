...
class Settings:
    ...
    def get_boto3_sqs(self):
        ...
        try:
            # Let boto3 auto-configure endpoint based on region
            # Do NOT specify endpoint_url - it causes "wsdl version" errors
            logger.info(f"Creating SQS client for region: {self.AWS_REGION}")
